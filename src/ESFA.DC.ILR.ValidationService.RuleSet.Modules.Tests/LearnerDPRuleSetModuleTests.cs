...
{
    public class LearnerDPRuleSetModuleTests
    {
        /// <summary>
        ...
        public IReadOnlyCollection<Type> GetAssemblyRuleSet()
        {
            ...
            return asm.GetTypes().Where(x => typeof(IRule<ILearnerDestinationAndProgression>).IsAssignableFrom(x)).ToList();
        }

        /// <summary>
        /// Gets the container rule set.
        /// </summary>
        /// <returns>a collection of <see cref="IRule{ILearnerDestinationAndProgression}"/></returns>
        public IReadOnlyCollection<IRule<ILearnerDestinationAndProgression>> GetContainerRuleSet()
        {
            ...
            return container.Resolve<IEnumerable<IRule<ILearnerDestinationAndProgression>>>().ToList();
        }
