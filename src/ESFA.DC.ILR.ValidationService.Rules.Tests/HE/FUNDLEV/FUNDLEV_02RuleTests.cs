...
{
    public class FUNDLEV_02RuleTests : AbstractRuleTests<FUNDLEV_02Rule>
    {
        [Fact]
        public void RuleName()
        {
            NewRule().RuleName.Should().Be("FUNDLEV_02");
        }
        ...
        private FUNDLEV_02Rule NewRule(
            ILARSDataService larsDataService = null,
            IValidationErrorHandler validationErrorHandler = null)
        {
            return new FUNDLEV_02Rule(larsDataService, validationErrorHandler);
        }
    }
}
