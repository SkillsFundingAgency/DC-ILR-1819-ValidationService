...
{
    public class DateOfBirth_28RuleTests : AbstractRuleTests<DateOfBirth_28Rule>
    {
        [Fact]
        public void RuleName()
        {
            NewRule().RuleName.Should().Be("DateOfBirth_28");
        }
        ...
        public void ApprenticeshipDurationConditionMet_False()
        {
            ...
            dateTimeQueryServiceMock.Setup(qs => qs.MonthsBetween(learnStartDate, learnPlanEndDate)).Returns(12);
        ...
        public void ConditionMet_True()
        {
            ...
            var dateOfBirth = new DateTime(1996, 01, 01);
            var progType = 25;
        ...
        private DateOfBirth_28Rule NewRule(IDateTimeQueryService dateTimeQueryService = null, IDerivedData_07Rule dd07 = null, ILearningDeliveryFAMQueryService learningDeliveryFamQueryService = null, IValidationErrorHandler validationErrorHandler = null)
        {
            return new DateOfBirth_28Rule(dateTimeQueryService, dd07, learningDeliveryFamQueryService, validationErrorHandler);
        }
    }
}
