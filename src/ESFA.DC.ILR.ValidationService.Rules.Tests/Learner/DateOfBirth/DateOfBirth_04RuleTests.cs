...
{
    public class DateOfBirth_04RuleTests : AbstractRuleTests<DateOfBirth_04Rule>
    {
        [Fact]
        public void RuleName()
        {
            NewRule().RuleName.Should().Be("DateOfBirth_04");
        }
        ...
        {
            var dateOfBirth = new DateTime(1910, 01, 01);
            ...
            dateTimeQueryServiceMock.Setup(qs => qs.YearsBetween(dateOfBirth, start)).Returns(118);
        ...
        private DateOfBirth_04Rule NewRule(IAcademicYearDataService academicYearDataService = null, IDateTimeQueryService dateTimeQueryService = null, IValidationErrorHandler validationErrorHandler = null)
        {
            return new DateOfBirth_04Rule(academicYearDataService, dateTimeQueryService, validationErrorHandler);
        }
    }
}
