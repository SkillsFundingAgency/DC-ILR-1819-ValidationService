...
{
    public class AchDate_05RuleTests : AbstractRuleTests<AchDate_05Rule>
    {
        [Fact]
        public void RuleName()
        {
            NewRule().RuleName.Should().Be("AchDate_05");
        }
        ...
        [Fact]
        public void ConditionMet_False_NullLearnActEndDate()
        {
        ...
        private AchDate_05Rule NewRule(IValidationErrorHandler validationErrorHandler = null)
        {
            return new AchDate_05Rule(validationErrorHandler);
        }
    }
}
