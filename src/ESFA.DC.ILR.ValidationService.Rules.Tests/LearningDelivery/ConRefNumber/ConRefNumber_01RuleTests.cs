...
{
    public class ConRefNumber_01RuleTests : AbstractRuleTests
    {
        [Fact]
        ...
        public void ConditionMet_True()
        {
            ...
            var ruleMock = new Mock<ConRefNumber_01Rule>
            {
                CallBase = true
            };
        ...
        [Fact]
        public void ConRefNumberConditionMet_False_Null()
        {
            NewRule().ConRefNumberConditionMet(null).Should().BeTrue();
        }

        [Fact]
        public void ConRefNumberConditionMet_False_WhiteSpace()
        {
