    ...
    public class R62RuleTests : AbstractRuleTests<R62Rule>
    {
        ...
        public void Validate_Error()
        {
            ...
            learningDeliveryFAMQueryServiceMock
                .Setup(qs => qs.GetOverLappingLearningDeliveryFAMsForType(learningDeliveryFAMs, _famTypeALB))
        ...
        public void Validate_NoError_NoACTFams()
        {
            ...
            learningDeliveryFAMQueryServiceMock
                .Setup(qs => qs.GetOverLappingLearningDeliveryFAMsForType(It.IsAny<IReadOnlyCollection<TestLearningDeliveryFAM>>(), _famTypeALB))
        ...
        {
            var famType = Monitoring.Delivery.Types.AdvancedLearnerLoansBursaryFunding;
            var learnDelFamDateFrom = new DateTime(2018, 8, 1);
            var learnDelFamDateTo = new DateTime(2018, 8, 1);

            var validationErrorHandlerMock = new Mock<IValidationErrorHandler>();

            validationErrorHandlerMock.Setup(veh => veh.BuildErrorMessageParameter("LearnDelFAMType", "ALB")).Verifiable();
        ...
        public R62Rule NewRule(ILearningDeliveryFAMQueryService learningDeliveryFAMQueryService = null, IValidationErrorHandler validationErrorHandler = null)
        {
            return new R62Rule(learningDeliveryFAMQueryService, validationErrorHandler);
        }
    }
}
