...
{
    public class R56Rule : AbstractRule, IRule<ILearner>
    {
        public R56Rule(IValidationErrorHandler validationErrorHandler)
            : base(validationErrorHandler, RuleNameConstants.R56)
        {
        }
