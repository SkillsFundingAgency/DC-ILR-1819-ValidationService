...
namespace ESFA.DC.ILR.ValidationService.Rules.LearningDelivery.DelLocPostCode
{
    public class DelLocPostCode_17Rule :
        DelLocPostCode_EligibilityRuleBase<IEsfEligibilityRuleLocalAuthority>
    {
        /// <summary>
        ...
        /// </returns>
        public override string GetName() => "DelLocPostCode_17";
        ...
        public override IEsfEligibilityRuleLocalAuthority GetEligibilityItem(ILearningDelivery delivery) =>

            // This is wrong it should return Collection
            FcsData.GetEligibilityRuleLocalAuthoritiesFor(delivery.ConRefNumber).FirstOrDefault();
        ...
        /// </returns>
        public override bool HasQualifyingEligibility(IONSPostcode postcode, IEsfEligibilityRuleLocalAuthority eligibility) =>
            It.Has(postcode)
                && It.Has(eligibility)
                && eligibility.Code.ComparesWith(postcode.LocalAuthority);
    }
}
