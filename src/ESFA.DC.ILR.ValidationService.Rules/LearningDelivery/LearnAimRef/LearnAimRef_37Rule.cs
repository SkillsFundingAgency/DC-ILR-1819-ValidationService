...
namespace ESFA.DC.ILR.ValidationService.Rules.LearningDelivery.LearnAimRef
{
        ...
        IRule<ILearner>
    {
        ...
        /// </summary>
        public DateTime LastInviableDate => new DateTime(2011, 07, 31);
        ...
        public bool IsQualifyingFunding(ILearningDelivery delivery) =>
            IsApprenticeshipFunded(delivery) || IsOtherFunded(delivery);
        ...
        public void Validate(ILearner objectToValidate)
        {
            ...
            objectToValidate.LearningDeliveries
                .SafeWhere(x => !IsExcluded(x) && IsViableStart(x) && IsQualifyingFunding(x))
                .ForEach(x =>
                {
