    ...
    public class UKPRN_14Rule : AbstractRule, IRule<ILearner>
    {
        ...
        public void Validate(ILearner objectToValidate)
        {
            ...
            foreach (var learningDelivery in objectToValidate.LearningDeliveries.Where(d => d.LearningDeliveryFAMs != null))
            {
                ...
                {
                    HandleValidationError(objectToValidate.LearnRefNumber, learningDelivery.AimSeqNumber, BuildErrorMessageParameters(ukprn, learningDelivery.FundModel, _learnDelFamType, "2"));
                }
            }
        }
