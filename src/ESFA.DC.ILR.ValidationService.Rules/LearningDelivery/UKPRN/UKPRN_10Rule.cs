    ...
    public class UKPRN_10Rule : AbstractRule, IRule<ILearner>
    {
        ...
        public void Validate(ILearner objectToValidate)
        {
            ...
            foreach (var learningDelivery in objectToValidate.LearningDeliveries.Where(d => _fundModel == d.FundModel && d.LearningDeliveryFAMs != null))
            {
                ...
                {
                    HandleValidationError(objectToValidate.LearnRefNumber, learningDelivery.AimSeqNumber, BuildErrorMessageParameters(ukprn, learningDelivery.FundModel, LearningDeliveryFAMTypeConstants.ADL, "1"));
                }
            }
        }
