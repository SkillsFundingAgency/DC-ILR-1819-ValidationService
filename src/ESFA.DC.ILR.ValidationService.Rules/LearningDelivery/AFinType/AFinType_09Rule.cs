...
namespace ESFA.DC.ILR.ValidationService.Rules.LearningDelivery.AFinType
{
        ...
        IRule<ILearner>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AFinType_09Rule"/> class.
        /// </summary>
        /// <param name="validationErrorHandler">The validation error handler.</param>
        public AFinType_09Rule(IValidationErrorHandler validationErrorHandler)
        {
        ...
        public bool IsInTraining(ILearningDelivery delivery) =>
            delivery.FundModel == TypeOfFunding.OtherAdult
