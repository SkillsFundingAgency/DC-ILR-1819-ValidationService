...
namespace ESFA.DC.ILR.ValidationService.Rules.Learner.DateOfBirth
{
    public class DateOfBirth_04Rule : AbstractRule, IRule<ILearner>
    {
        ...
        public DateOfBirth_04Rule(IValidationDataService validationDataService, IDateTimeQueryService dateTimeQueryService, IValidationErrorHandler validationErrorHandler)
        ...
        public void Validate(ILearner objectToValidate)
        {
            ...
            {
                HandleValidationError(RuleNameConstants.DateOfBirth_04, objectToValidate.LearnRefNumber);
            }
        }
