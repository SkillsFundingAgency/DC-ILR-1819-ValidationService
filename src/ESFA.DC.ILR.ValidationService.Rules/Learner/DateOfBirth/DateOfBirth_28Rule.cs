...
namespace ESFA.DC.ILR.ValidationService.Rules.Learner.DateOfBirth
{
    public class DateOfBirth_28Rule : AbstractRule, IRule<ILearner>
    {
        ...
        public DateOfBirth_28Rule(IDateTimeQueryService dateTimeQueryService, IDerivedData_07Rule dd07, ILearningDeliveryFAMQueryService learningDeliveryFAMQueryService, IValidationErrorHandler validationErrorHandler)
