...
namespace ESFA.DC.ILR.ValidationService.Rules.HE.FinancialSupport.FINTYPE
{
        ...
        IRule<ILearner>
    {
        ...
        /// </summary>
        public const string Name = "FINTYPE_01";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FINTYPE_01Rule"/> class.
        /// </summary>
        /// <param name="validationErrorHandler">The validation error handler.</param>
        public FINTYPE_01Rule(IValidationErrorHandler validationErrorHandler)
        {
        ...
        public bool ConditionMet(IReadOnlyCollection<ILearnerHEFinancialSupport> financialSupport)
        {
            return It.HasValues(financialSupport)
                ? financialSupport.All(x => TypeOfFinancialSupport.AsASet.Contains(x.FINTYPE))
                : true;
        }
