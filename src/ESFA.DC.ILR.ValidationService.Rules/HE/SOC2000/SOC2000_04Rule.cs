...
{
    public class SOC2000_04Rule : AbstractRule, IRule<ILearner>
    {
        ...
        public SOC2000_04Rule(
            IProvideLookupDetails provideLookupDetails,
            IValidationErrorHandler validationErrorHandler)
            : base(validationErrorHandler, RuleNameConstants.SOC2000_04)
        {
        ...
        public bool ConditionMet(DateTime learnStartDate, int soc2000)
        {
            return learnStartDate >= _firstAugust2014
                   && !_provideLookupDetails.Contains(TypeOfIntegerCodedLookup.SOC2010, soc2000);
        }
