...
namespace ESFA.DC.ILR.ValidationService.Rules.HE.LearningDeliveryHE
{
    public class LearningDeliveryHE_07Rule : AbstractRule, IRule<ILearner>
    {
        ...
        public void Validate(ILearner objectToValidate)
        {
            ...
            {
                if (ConditionMet(learningDelivery.ProgTypeNullable, learningDelivery.LearnAimRef, learningDelivery.LearningDeliveryHEEntity, learningDelivery.LearningDeliveryFAMs))
                {
